...
const ProjectsCard: React.FC = () => {
  ...
  return (
    ...
    >
      <div className=" md:w-2/3 h-[700px] overflow-y-scroll sm:border sm:border-my-blue-900 shadow-2xl sm:shadow-my-blue-700 pt-3 sm:px-6 sm:pt-6 rounded-2xl">
...
// <div className='flex'><Icon size={30}/><Icon size={30}/><Icon size={30}/></div>