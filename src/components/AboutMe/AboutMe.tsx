...
const AboutMe: React.FC = () => {
    return (
        <div>
            ...
            <p>
                My passion for web development is complemented by a rich array of interests outside the professional sphere, including pottery, dancing, and fitness. These hobbies reflect my curious attitude towards life and my dedication to continual personal growth. I have assisted a startup in creating digital projects, a testament to my commitment to applying and expanding my technical skills. My journey has been one of constant upskilling and self-improvement, with a clear goal of mastering front-end development. I am determined to leverage my diverse experiences and relentless curiosity to excel in the tech industry, bringing a unique perspective and a robust skill set to every project I undertake.</p>
        </div>
    )
}
