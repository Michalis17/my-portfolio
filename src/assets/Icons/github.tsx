// https://github.com/Michalis17

import React from 'react'
type colorProp = 'white' | 'base' | 'green';
interface Props {
    size: number;
    color?: colorProp;
}
